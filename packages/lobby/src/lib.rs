                                ...
                                html! {
                                    <>
                                        ...
                                        <div class="flex justify-center">
                                            ...
                                            <button onclick={Callback::from(|_| clipboard::wirteClickBoard(&window().unwrap().location().href().unwrap()))}>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-black hover:text-black-light w-5 h-5">
